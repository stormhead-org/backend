...
const (
	...
	FeedService_GetPersonalizedFeed_FullMethodName = "/proto.FeedService/GetPersonalizedFeed"
)
...
func (c *feedServiceClient) GetPersonalizedFeed(ctx context.Context, in *GetPersonalizedFeedRequest, opts ...grpc.CallOption) (*GetPersonalizedFeedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPersonalizedFeedResponse)
	err := c.cc.Invoke(ctx, FeedService_GetPersonalizedFeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFeedServiceServer) GetPersonalizedFeed(context.Context, *GetPersonalizedFeedRequest) (*GetPersonalizedFeedResponse, error) {
...
func _FeedService_GetPersonalizedFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPersonalizedFeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeedServiceServer).GetPersonalizedFeed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FeedService_GetPersonalizedFeed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).GetPersonalizedFeed(ctx, req.(*GetPersonalizedFeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FeedService_GetPersonalizedFeed_Handler,
		},
	},
